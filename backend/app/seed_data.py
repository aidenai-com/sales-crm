...
# (key, name, industry, is_partner, owner email)
ACCOUNTS = (
    ("jpmc", "JPMorgan Chase", "Banking", False, "priya.raghavan@aidenai.com"),
    ("bofa", "Bank of America", "Banking", False, "marcus.feld@aidenai.com"),
    ("citi", "Citigroup", "Banking", False, "priya.raghavan@aidenai.com"),
    ("wells", "Wells Fargo", "Banking", False, "marcus.feld@aidenai.com"),
    ("hsbc", "HSBC", "Banking", False, "aisha.bennett@aidenai.com"),
    ("pru", "Prudential Financial", "Insurance", False, "priya.raghavan@aidenai.com"),
    ("aetna", "Aetna", "Health Insurance", False, "aisha.bennett@aidenai.com"),
    ("accenture", "Accenture", "Systems Integrator", True, "dana.okonkwo@aidenai.com"),
    ("deloitte", "Deloitte", "Systems Integrator", True, "dana.okonkwo@aidenai.com"),
    ("ntt", "NTT Data", "Systems Integrator", True, "dana.okonkwo@aidenai.com"),
    ("virtusa", "Virtusa", "Systems Integrator", True, "dana.okonkwo@aidenai.com"),
)

# (key, account key, business unit, owner email)
LEADS = (
    ("jpmc-1", "jpmc", "Corporate & Investment Bank", "priya.raghavan@aidenai.com"),
    ("jpmc-2", "jpmc", "Consumer Banking Technology", "marcus.feld@aidenai.com"),
    ("jpmc-3", "jpmc", "Risk & Compliance", "aisha.bennett@aidenai.com"),
    ("bofa-1", "bofa", "Wealth & Asset Management", "marcus.feld@aidenai.com"),
    ("bofa-2", "bofa", "Compliance", "aisha.bennett@aidenai.com"),
    ("citi-1", "citi", "Global Markets Technology", "priya.raghavan@aidenai.com"),
    ("citi-2", "citi", "Treasury & Trade Solutions", "priya.raghavan@aidenai.com"),
    ("wells-1", "wells", "Consumer Lending Platform", "marcus.feld@aidenai.com"),
    ("hsbc-1", "hsbc", "Commercial Banking", "aisha.bennett@aidenai.com"),
    ("hsbc-2", "hsbc", "Financial Crime Technology", "aisha.bennett@aidenai.com"),
    ("pru-1", "pru", "Claims Operations", "priya.raghavan@aidenai.com"),
    ("aetna-1", "aetna", "Member Platform Engineering", "aisha.bennett@aidenai.com"),
)
...
#  days until close, owner email, partner key)
...
DEALS = (
    ("d1", "Core Banking AI Modernization", "jpmc", "jpmc-1", "AidenAI Direct", "Proposal, Negotiation & Close", 4_200_000, 5, "priya.raghavan@aidenai.com", None),
    ("d2", "Mainframe COBOL Refactor", "jpmc", "jpmc-2", "AidenAI Direct", "Technical Validation & ROI Diagnostic", 2_750_000, 48, "marcus.feld@aidenai.com", None),
    ("d3", "Regulatory Reporting Agents", "jpmc", "jpmc-3", "AidenAI Direct", "Discover & Qualify", 890_000, 96, "aisha.bennett@aidenai.com", None),
    ("d4", "Advisor Copilot Platform", "bofa", "bofa-1", "AidenAI Direct", "Technical Validation & ROI Diagnostic", 3_100_000, 31, "marcus.feld@aidenai.com", None),
    ("d5", "Surveillance Model Rebuild", "bofa", "bofa-2", "AidenAI Direct", "Solution Alignment & Competitive Strategy", 1_450_000, 70, "aisha.bennett@aidenai.com", None),
    ("d6", "Trading Platform Latency Programme", "citi", "citi-1", "AidenAI Direct", "Proposal, Negotiation & Close", 5_600_000, -9, "priya.raghavan@aidenai.com", None),
    ("d7", "Payments Reconciliation Agents", "citi", "citi-2", "AidenAI Direct", "Solution Alignment & Competitive Strategy", 1_180_000, 58, "priya.raghavan@aidenai.com", None),
    ("d8", "Loan Origination Rewrite", "wells", "wells-1", "AidenAI Direct", "Discover & Qualify", 2_300_000, 84, "marcus.feld@aidenai.com", None),
    ("d9", "AI Centre of Innovation", "hsbc", "hsbc-1", "AidenAI Direct", "Deploy & Develop", 6_900_000, -26, "aisha.bennett@aidenai.com", None),
    ("d10", "Financial Crime Detection Uplift", "hsbc", "hsbc-2", "AidenAI Direct", "Technical Validation & ROI Diagnostic", 2_050_000, 6, "aisha.bennett@aidenai.com", None),
    ("d11", "Claims Automation Discovery", "pru", "pru-1", "AidenAI Direct", "Prospecting", 640_000, 140, "priya.raghavan@aidenai.com", None),
    ("d12", "Legacy Policy Admin Assessment", "pru", None, "AidenAI Direct", "Prospecting", 320_000, 120, "priya.raghavan@aidenai.com", None),
    ("d13", "Member Portal Re-platform", "aetna", "aetna-1", "AidenAI Direct", "Discover & Qualify", 1_900_000, 77, "aisha.bennett@aidenai.com", None),
    # Closed Lost at 0%: proves open pipeline is read from stage kind, not probability.
    ("d21", "Data Lake Consolidation", "wells", "wells-1", "AidenAI Direct", "Closed Lost", 1_600_000, -37, "marcus.feld@aidenai.com", None),
    # R8: partner-led deals carry both the Partner and the Customer on one record.
    ("d14", "Wealth Data Platform (co-sell)", "bofa", "bofa-1", "Partner Co-Sell", "Co-Sell Pipeline", 3_400_000, 42, "dana.okonkwo@aidenai.com", "accenture"),
    ("d15", "Risk Engine Modernization (co-sell)", "citi", "citi-1", "Partner Co-Sell", "Joint Proposal", 4_800_000, 4, "dana.okonkwo@aidenai.com", "deloitte"),
    ("d16", "AiDAP Enablement Programme", "wells", None, "Partner Co-Sell", "Onboarding", 450_000, 64, "dana.okonkwo@aidenai.com", "ntt"),
    ("d17", "Branch Systems Migration (co-sell)", "hsbc", "hsbc-1", "Partner Co-Sell", "Enabled", 2_600_000, 90, "dana.okonkwo@aidenai.com", "virtusa"),
    ("d18", "Insurance Practice Joint GTM", "pru", "pru-1", "Partner Co-Sell", "Identify", 780_000, 155, "dana.okonkwo@aidenai.com", "deloitte"),
    ("d19", "Claims Agents Pilot (co-sell)", "aetna", "aetna-1", "Partner Co-Sell", "Co-Sell Pipeline", 1_250_000, -3, "dana.okonkwo@aidenai.com", "accenture"),
    ("d20", "Consumer Bank Delivery Partnership", "jpmc", "jpmc-2", "Partner Co-Sell", "Closed Won", 5_100_000, -18, "dana.okonkwo@aidenai.com", "accenture"),
    ("d22", "Treasury Agents Pilot (co-sell)", "citi", "citi-2", "Partner Co-Sell", "Closed Lost", 520_000, -52, "dana.okonkwo@aidenai.com", "ntt"),
)
